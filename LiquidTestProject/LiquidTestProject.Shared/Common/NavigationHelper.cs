...
namespace LiquidTestProject.Common
{
    /// <summary>
    ...
    ///     }
    ///     
    ///     internal async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
    ///     { }
    ///     internal async void navigationHelper_SaveState(object sender, LoadStateEventArgs e)
    ///     { }
    /// </code>
    /// 
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        internal Frame Frame { get { return Page.Frame; } }
        ...
        public NavigationHelper(Page page)
        {
            ...
            Page.Loaded += (sender, e) =>
            {
                ...
                if (Math.Abs(Page.ActualHeight - Window.Current.Bounds.Height) < 0.1 &&
                    Math.Abs(Page.ActualWidth - Window.Current.Bounds.Width) < 0.1)
                {
        ...
        public RelayCommand GoForwardCommand
        {
            get
            {
                return _goForwardCommand ?? (_goForwardCommand = new RelayCommand(GoForward, CanGoForward));
            }
        }
        ...
        internal void HardwareButtons_BackPressed(object sender, Windows.Phone.UI.Input.BackPressedEventArgs e)
        {
        ...
        /// <param name="sender">Instance that triggered the event.</param>
        /// <param name="e">Event data describing the conditions that led to the event.</param>
        internal void CoreDispatcher_AcceleratorKeyActivated(CoreDispatcher sender,
        ...
        /// <param name="sender">Instance that triggered the event.</param>
        /// <param name="e">Event data describing the conditions that led to the event.</param>
        internal void CoreWindow_PointerPressed(CoreWindow sender,
            PointerEventArgs e)
        {
    ...
    public class LoadStateEventArgs : EventArgs
    {
        ...
        /// </summary>
        public Dictionary<string, Object> PageState { get; internal set; }
